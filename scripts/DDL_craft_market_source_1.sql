...
CREATE TABLE source1.craft_market_wide (
	...
	craftsman_id BIGINT GENERATED by DEFAULT AS IDENTITY NOT NULL, -- идентификатор мастера
	...
	product_id BIGINT GENERATED by DEFAULT AS IDENTITY NOT NULL, -- идентификтор товара ручной работы
	...
	order_id BIGINT GENERATED by default as identity NOT NULL, -- идентификатор заказа
	...
	customer_id BIGINT GENERATED by DEFAULT AS IDENTITY NOT NULL, -- идентификатор заказчика
